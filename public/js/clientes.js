...
function alternarTipoCliente(tipo) {
    ...
    if (camposPessoaFisica) {
        camposPessoaFisica.style.display = tipoCliente === "fisica" ? "block" : "none";
    }

    if (camposPessoaJuridica) {
        camposPessoaJuridica.style.display = tipoCliente === "juridica" ? "block" : "none";
    }
...
async function salvarCliente(event) {
    ...
    try {
        ...
        if (documentoDuplicado) {
            mostrarMensagem("Erro", "Já existe um cliente cadastrado com este CPF/CNPJ.", "error");
        ...
        mostrarMensagem("Erro", "Erro ao salvar cliente: " + error.message, "error");
    }
}
...
async function editarCliente(clienteId) {
    try {
        ...
        const botaoSalvar = document.querySelector('#clienteForm button[type="submit"]');

        if (botaoSalvar) {
            botaoSalvar.innerHTML = '<i class="fas fa-sync-alt"></i> Atualizar Cliente';
        }
        ...
        mostrarMensagem("Erro", "Não foi possível carregar o cliente para edição.", "error");
    }
}
...
async function excluirCliente(clienteId) {
    ...
    try {
        ...
        mostrarMensagem("Erro", "Erro ao excluir cliente: " + error.message, "error");
    }
}
