...
document.addEventListener("DOMContentLoaded", async function () {
    try {
        ...
        mostrarMensagem("Erro", "Não foi possível inicializar a tela de estoque.", "error");
    }
});
...
function atualizarEstatisticasEstoque() {
    ...
    estoque.forEach((item) => {
        ...
        const foraDeUso = Math.max(0, quantidadeTotal - quantidadeDisponivel - quantidadeAlugada);
...
async function visualizarDetalhes(equipamentoId) {
    try {
        ...
        conteudo.innerHTML = `
            ...
            <div class="stats-grid" style="display:flex !important; gap: 20px; flex-wrap: wrap; margin-top: 20px;">
                <div class="stat-card">
                    <div class="stat-icon">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3>${Number(equipamento.quantidadeManutencao || 0)}</h3>
                        <p>Manutenção</p>
                    </div>
                </div>
            </div>
...
window.fecharModalDetalhesEstoque = fecharModalDetalhesEstoque;
