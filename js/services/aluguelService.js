(function () {
    ...
    function gerarCodigoContratoPorNumero(numeroAluguel, dataInicio) {
    ...
    window.AluguelService = {
        async listar() {
            ...
            const snapshot = await db.collection("alugueis").orderBy("dataRegistro", "desc").get();
        ...
        async registrar(dados) {
            ...
            await db.runTransaction(async function (transaction) {
                ...
                const ultimoNumero = contadorDoc.exists
                    ? Number(contadorDoc.data().ultimoNumero || 0)
                    : 0;

                const numeroAluguel = ultimoNumero + 1;
        ...
        async finalizar(aluguelId, fechamento = {}) {
            ...
            await db.runTransaction(async function (transaction) {
                ...
                const periodoCobranca = fechamento.periodoCobranca || fechamento.periodo;
